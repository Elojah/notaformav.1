...
func GetData(dataID string, collectionID string, accessToken string) (result models.JSONContentSingleData, err error) {
...
func GetDataWithQuery(query models.QueryModel, collectionID string, accessToken string) (result models.JSONContent, err error) {
